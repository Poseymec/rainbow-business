<template>
  <footer class="bg-gray-900 text-white pt-12 pb-8 px-4 md:px-8 border-t border-gray-800">
...
// Icônes des réseaux sociaux (tu peux les remplacer par les tiennes)
import {
  IconBrandFacebook,
  IconBrandTwitter,
  IconBrandInstagram,
...
footer a:hover {
  color: #f87171; /* rouge doux au hover */
}
</style>